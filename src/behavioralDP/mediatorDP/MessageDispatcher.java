...
public class MessageDispatcher implements Dispatcher{
    ...
    // dispatcher should know which actor/expert is should answer the question on topic.
    ...
    public void dispatch(String topic, String message) {
        // get message from actor/experts
        // first we need to find topic
        Expert expert = registeredExperts.get(topic);
        if(expert == null){
            System.out.println("No expert registered for this topic");
        }else{
